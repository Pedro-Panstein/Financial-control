...
export function TransactionFilters({
  ...
  // Extração dinâmica dos anos disponíveis
  const yearOptions = Array.from(
    new Set(transactions.map((t) => new Date(t.date).getFullYear()))
  ).sort((a, b) => b - a); // ordena do mais recente ao mais antigo
          ...
          <div className="space-y-4">
            ...
            {(filters.period === "custom" || filters.period === "all") && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 p-4 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-blue-900/30 rounded-lg border dark:border-gray-700">
                ...
                <div>
                  <label className="text-sm font-medium mb-2 block text-gray-700 dark:text-gray-300">
                    {translations.filters.finalDate}
                  </label>
                  <Input
                    type="date"
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="all">
                        {translations.filters.typeContent.all}
                      </SelectItem>
                      <SelectItem value="income">
                        {translations.filters.typeContent.income}
                      </SelectItem>
                      <SelectItem value="expense">
                        {translations.filters.typeContent.expense}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
